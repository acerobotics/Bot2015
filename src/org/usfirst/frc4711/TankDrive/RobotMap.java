...
public class RobotMap {
    ...
    public static SpeedController forkliftarmMotor2;
    public static RobotDrive forkliftcontrol;
    ...
    public static void init() {
        ...
        forkliftarmMotor = new Talon(5);
        LiveWindow.addActuator("Forklift", "armMotor", (Talon) forkliftarmMotor);
        
        forkliftarmMotor2 = new Talon(6);
        
        forkliftcontrol = new RobotDrive(forkliftarmMotor, forkliftarmMotor2);
        
        forkliftcontrol.setSafetyEnabled(true);
        forkliftcontrol.setExpiration(0.1);
        forkliftcontrol.setSensitivity(0.5);
        forkliftcontrol.setMaxOutput(1.0);
